...
<div class="row">
	<div class="col-xs-12">
		...
		<form id="_editForm" class="form-horizontal" role="form" 
			...
			<div class="form-group">
				<label for="_sort" class="col-sm-3 control-label no-padding-right">业务编码</label>

				<div class="col-sm-6">
					<div class="clearfix help-validate">
						<input id="_busiCode" name="busiCode" type="text" value="${role.busiCode}" class="form-data col-xs-10 col-sm-5" placeholder="业务编码"
							  maxlength="64"/>
					</div>
				</div>
