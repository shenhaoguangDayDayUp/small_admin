					...
					<div class="widget-body">
						<div class="widget-main">
							<form id="_form" class="form-inline">
								...
								<label>
									<label class="control-label" for="form-field-1"> 业务编号： </label>
									<input name="busiCode" type="text" class="form-data input-medium search-data">
								</label>
		...
		jQuery(function($) {
    		...
    		var $table = $("#_table").table({
				...
				columns : [
			        ...
			        {field:'busiCode', title:'业务编码', align:'left'},
