...
<link rel="stylesheet" href="${_staticPath}/assets/css/bootstrap.min.css" />
<!-- 文本框 -->
<link rel="stylesheet" href="${_staticPath}/assets/css/jquery-ui.custom.css" />
<!-- 下拉框 -->
<link rel="stylesheet" href="${_staticPath}/assets/css/bootstrap-select.min.css" />
<!-- 多选框 -->
...
<script type="text/javascript">
	var scripts = [
		"${_staticPath}/assets/js/bootstrap.js",
		"${_staticPath}/assets/js/bootstrap.min.js",
		// Form提交Json转换
		"${_staticPath}/custom/jquery.form.min.js",
		// 列表
		"${_staticPath}/custom/jquery.table.min.js?v=" + Math.random(),
		// 下拉框
		"${_staticPath}/assets/js/bootstrap-select.js",
		"${_staticPath}/assets/js/bootstrap-select.min.js",
		// 时间
		...
		//"${_staticPath}/assets/js/date-time/bootstrap-datetimepicker.min.js",
		"${_staticPath}/assets/js/date-time/bootstrap-datetimepicker.zh-CN.js",
		// 确认框
