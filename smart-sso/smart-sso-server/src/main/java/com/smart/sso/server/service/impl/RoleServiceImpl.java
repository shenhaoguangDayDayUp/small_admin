...
public class RoleServiceImpl extends ServiceImpl<RoleDao, Role, Integer> implements RoleService {
	...
	public Pagination<Role> findPagination(String name,String busiCode, Pagination<Role> p) {
		dao.findPagination(name, busiCode,null, p);
		return p;
	}

	public List<Role> findByAll(Boolean isEnable) {
		return dao.findPagination(null, null,isEnable, null);
	}
	...
	public List<Role> findListByUserId(Integer userId,String busiCode){
		return dao.findListByUserId(userId,busiCode);
	}
}
