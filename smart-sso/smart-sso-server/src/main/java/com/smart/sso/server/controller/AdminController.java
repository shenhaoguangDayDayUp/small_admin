...
public class AdminController {
	...
	public String execute(HttpServletRequest request, Model model) {
		...
		/*System.out.println("sessionUser token id="+sessionUser.getToken());
		System.out.println("sessionUser id="+sessionUser.getUserId());
		System.out.println("sessionUser getManageUserIds="+sessionUser.getManageUserIds());
		System.out.println("sessionUser getRoleBusiCode="+sessionUser.getRoleBusiCode());*/
		// 设置登录用户名
